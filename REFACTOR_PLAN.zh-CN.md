...
- `44ee598c`：完成 UI 基础层；`ee321149`、`5b123cfb`、`4193bbad`：完成本轮状态反馈、移动端抽屉、设置分组、国际化、登录反馈和空/加载状态；`npm run lint -- --no-fix` 无错误，`npm run build` 构建成功。构建仅提示既有未使用类型和 bundle 体积 warning，未阻断交付。
